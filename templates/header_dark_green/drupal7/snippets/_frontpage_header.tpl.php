<header role="banner" class="header-wrap header-header1-menu <?php print $navbar_classes; ?>" id = "navbar" data-spy="affix"  data-offset-top="70">
...
<?php print render($page['header_dark_green']); ?>
