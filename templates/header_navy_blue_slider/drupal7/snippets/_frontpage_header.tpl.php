<header role="banner" class="header-wrap header-navyblue-slider-menu <?php print $navbar_classes; ?>" id = "navbar" data-spy="affix"  data-offset-top="70">
...
<?php print render($page['header_navy_blue_slider']); ?>
