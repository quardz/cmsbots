<footer id = "footer" class = "footer-section section footer-voilet-big text-center">
  <?php if ($page['footer_signup']): ?>
  <div class = "footer-subscribe xs-text-center">
    <div class = "container">
      <div class = "row">
  ...
  <div class = "footer-copyright-social horizontal-menu xs-text-center">
    <div class = "container">
      <div class = "row">
