<header role="banner" class="header-wrap header-freshway-menu header-mobile-menu <?php print $navbar_classes; ?>" id = "navbar" data-spy="affix"  data-offset-top="80">
...
<?php print render($page['header_fresh_way']); ?>
